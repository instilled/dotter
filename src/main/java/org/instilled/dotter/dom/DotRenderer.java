...
/**
 * A trivial {@link Dot} renderer. It supports rendering {@link Dot} to
 * string or a file.
 */
public class DotRenderer {
     ...
     *
     * @param dot The {@link Dot} to be rendered.
     ...
     * {@link Node} renderer.
     *
     * @param out {@link StringBuilder} into which to render.
     * @param dot The {@link Dot} instance to be rendered.
     */
     ...
     *
     * @param out   {@link StringBuilder} into which to render.
     * @param attrs Map of attributes where the key is the attribute name

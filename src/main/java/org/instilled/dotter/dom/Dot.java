...
public class Dot
{
     ...
     * 
     * @param name
     *            The name uniquely identifying this graph.
     * @param direction
     *            The graphs direction.
     */
     ...
     * 
     * @param id
     *            The {@link Node}s unique <code>id</code>.
     ...
     * 
     * @param nodes
     *            A list of {@link Node}s to be connected.
